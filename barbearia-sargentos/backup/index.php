...
//-----------------------------------------------------------------------------------------------------
 ...
 function gera_semana(){
	...
	$horario = array('08:30','09:00', '09:30', '10:00', '10:30','11:00', '16:00', '16:30', '17:00','17:31', '18:00', '18:30');
	$horarioSaQ = array('08:30','09:00', '09:30', '10:00', '10:30','11:00', '16:00', '16:30', '17:00', 'Não_disponível', 'Não_disponível', 'Não_disponível', 'Não_disponível');
	//echo $horario;
	//echo $segunda;
	//echo $diasemana;
 		...
 		<thead>
 			<tr> 
				...
				//SEXTA
							...
							if($horario[$i] == "13:00" || $horario[$i] == "13:45" /*|| $horario[$i] == "08:00" || $horario[$i] == "08:45"*/  ){
								echo "<td><font color=\"red\"><b>--</b></td>";
							}
							 else 
							if($militar_sexta[0] != ""){
